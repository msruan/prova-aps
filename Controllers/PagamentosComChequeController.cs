...
namespace estoque.Controllers
{
    public class PagamentosComChequeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Banco,NumeroDoCheque,NomeDoBanco,Id,NomeDoCobrado,InformacoesAdicionais")] PagamentoComCheque pagamentoComCheque)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Banco,NumeroDoCheque,NomeDoBanco,Id,NomeDoCobrado,InformacoesAdicionais")] PagamentoComCheque pagamentoComCheque)
        {
